    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          ...
          >
            ...
            <p className="text-xl md:text-2xl opacity-90 leading-relaxed mb-10 font-medium font-source-serif">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#start" className="px-8 py-4 bg-orange-500 text-white rounded-3xl font-bold hover:bg-orange-600 transition-all shadow-xl shadow-orange-500/20 flex items-center justify-center gap-2">
                Start a Fundraiser <Rocket className="w-5 h-5" />
              </a>
              <a href="#ideas" className="px-8 py-4 bg-white/10 backdrop-blur-md border border-white/20 text-white rounded-3xl font-bold hover:bg-white/20 transition-all flex items-center justify-center gap-2">
                Get Inspired
              </a>
            </div>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="order-2 lg:order-1">
              <div className="relative">
                <div className="absolute inset-0 bg-orange-200 rounded-3xl -rotate-3 opacity-30" />
                <ImageWithFallback
      ...
      <section className="py-24 bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-black mb-6 font-playfair">Tips for a Winning Campaign</h2>
            <p className="text-slate-400 text-lg font-source-serif">We've helped thousands of champions hit their goals. Here's how.</p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-12">
            {successTips.map((tip, i) => (
              <div key={i} className="space-y-4">
                ...
                <h3 className="text-xl font-bold font-playfair">{tip.title}</h3>
                <p className="text-slate-400 text-sm leading-relaxed font-source-serif">{tip.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="start" className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-white rounded-3xl shadow-2xl border border-slate-100 p-10 md:p-16">
