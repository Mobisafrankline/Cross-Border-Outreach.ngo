          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 divide-y lg:divide-y-0 lg:divide-x divide-gray-100">
            ...
            <div className="lg:col-span-2 p-8 lg:p-12">
              <div className="flex items-center space-x-4 mb-8">
                ...
                <h2 className="text-3xl font-bold text-navy-900 font-playfair">About the Initiative</h2>
              </div>
              ...
              <div className="prose prose-lg text-gray-600 max-w-none">
                ...
                {hasGuidelines && (
                  <div className="mt-12 bg-gray-50 rounded-3xl p-8 border border-gray-100">
                    <div className="flex items-center space-x-3 mb-6">
                      ...
                      <h3 className="text-xl font-bold text-navy-900 m-0 font-playfair">Eligibility & Guidelines</h3>
                    </div>
                ...
                <h3 className="text-xl font-bold text-navy-900 mt-10 mb-6 font-playfair">Key Focus Areas</h3>
            ...
            <div className="p-8 lg:p-12 bg-gray-50 flex flex-col justify-center">
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-navy-900 mb-4 font-playfair">Support This Cause</h3>
