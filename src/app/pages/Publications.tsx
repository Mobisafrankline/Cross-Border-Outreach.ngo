      ...
      <section className="relative py-28 md:py-36 overflow-hidden bg-navy-900">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed font-medium mb-10 font-source-serif">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col lg:flex-row items-center gap-10">
                {/* Document preview */}
                <div className="w-48 h-64 bg-white rounded-3xl shadow-2xl flex flex-col items-center justify-center text-center p-6 flex-shrink-0 transform -rotate-3 hover:rotate-0 transition-transform duration-500">
                ...
                <div className="flex-1 text-white text-center lg:text-left">
                  ...
                  <h2 className="text-3xl md:text-4xl font-black leading-tight tracking-tight mb-4 font-playfair">
                    {featured.title}
                  </h2>
                  <p className="text-blue-100/80 text-lg leading-relaxed mb-6 max-w-xl font-source-serif">
                  ...
                  >
                    ...
                    <div className="p-8 flex flex-col flex-1">
                      <div className="flex items-start gap-4 mb-6">
                        <div className={`w-14 h-14 ${style.bg} rounded-3xl flex items-center justify-center flex-shrink-0`}>
